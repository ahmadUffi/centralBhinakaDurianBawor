...
function CardProduct({ titleContent, titleCard, desc, image }) {
  ...
  return (
    ...
    { console.log(titleContent) }
      <div 
        className="card-product flex flex-col gap-y-8 p-4 custom-shadow bg-gradient-to-r from-darkYellow to-white rounded-xl sm:w-[44%] lg:w-[28%]" style={{ background: styleBgGradient }}
      >
