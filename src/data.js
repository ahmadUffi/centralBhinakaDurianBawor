...
const mitra = [
    ...
    listProducts: [
      {
        ...
        image: catalogDurian,
        description:
          "Temukan berbagai pilihan durian terbaik dengan kualitas premium. Mulai dari durian lokal hingga varietas unggulan, nikmati rasa manis dan tekstur lembut yang menggugah selera.",
      },
      {
        id: 2,
        title: "Catalog Bibit",
        image: catalogBibit,
        description:
          "Dapatkan bibit durian berkualitas tinggi yang siap ditanam. Cocok untuk petani maupun penghobi, bibit unggul kami memastikan pertumbuhan optimal dan hasil panen maksimal.",
      },
      {
        id: 3,
        ...
        image: catalogOlahan,
        description:
          "Jelajahi aneka olahan durian yang lezat, mulai dari kue, es krim, hingga camilan unik lainnya. Dibuat dengan bahan berkualitas, setiap gigitan menghadirkan cita rasa durian yang otentik.",
      },
    ],
    fasilitas: [
      {
  ...
  },
  {
    ...
    params: "mbahduren",
    description:
      "Saya, Budi Setiawan, pemilik Mbah Duren, dengan bangga menghadirkan berbagai jenis durian, termasuk varietas lokal unggulan. Pengalaman saya bertahun-tahun menjamin setiap durian yang dijual memiliki rasa dan kualitas terbaik.",
    image: budi,
    fotoToko: tokoMbah,
    kataPromosi:
