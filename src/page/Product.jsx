          ...
          <div className="mt-32 lg:mt-[6%]">
            ...
            >
              <div className="">
                <img
                  src={bgHeaderProduct}
                  className="absolute top-[38%] -z-10 scale-[1.8]"
                  alt="img-header-product"
                />
              </div>
              <div className="">
                <img
                  src={bgHeaderLeft}
                  className="absolute top-[10%] right-[30%] bg-cover bg-left -z-30 opacity-60 translate-x-0"
                  alt=""
                />
              </div>
              <div className="">
                <img
                  src={bgHeaderRight}
                  className="absolute -top-[10%] left-[30%] -z-30 bg-left opacity-60"
                  alt=""
                />
              </div>
              <div className="">
                <img
                  src={icProduct4}
                  className="absolute top-[30%] right-[11%] -z-20 size-20 sm:-translate-x-30"
                  alt="ic-product-right"
                />
              </div>
              <div className="">
                <img
                  src={icProduct2}
                  className="absolute top-[40%] left-[6%] -z-20 size-28 sm:translate-x-0"
                  alt="ic-product-left"
                />
              </div>
              <div className="flex flex-col items-center pt-5">
                <h1 className="text-primary text-3xl font-bold">DURIAN</h1>
            ...
            <div className="hidden sm:block">
              <img
                src={bgHeaderProductLg}
                className="custom-shadow bg-cover bg-center scale-90 rounded-3xl"
                alt=""
              />
            </div>
